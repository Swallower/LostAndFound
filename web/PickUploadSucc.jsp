...
//int Imagelength=(int)filename.length();
...
String sql=" insert into t_pick (userId,state,title,content,type,img,losttime,updatetime,place) values(?,?,?,?,?,?,?,?,?) ";
...
%>
<% 
	out.print("<script>alert('恭喜您，上传成功！希望失主可以尽快联系您！');</script>");
