...
<a style="position:absolute;left: 100px;top: -265px;" href="OutLogin.jsp" >退出</a>
...
<ul id="cardArea" class="card-area clearfix">
                    ...
                    <ul>                        
                        ...
                        <li>
                            ...
                            <div class="right">
                                ...
                                <a href="LostInformationAdmin.jsp" target="__blank">查看详情</a>
                            </div>
                        </li>
    ...
    <li class="card-item active">
        <div class="card">
            <div class="card-title title-even">
                <div class="content"><h1>管理员个人信息</h1></div>
            </div>
            <div class="card-content content-first">
                <div style="padding:50px;">点击查看管理员个人信息</div>
            </div>
                ...
                <div class="main-info">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="right">
                                <a href="PickInformationAdmin.jsp" target="__blank">查看详情</a>
                            </div>
                        </li>
                    </ul>
                </div>
