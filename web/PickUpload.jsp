...
<body>
    <div class="container" id="box">
        <form role="form" method="post" action="PickUploadSucc.jsp"style="margin-top:100px;">
        ...
        <label for="meeting">拾得日期：</label><input name="losttime" id="meeting"  type="datetime-local" value="2018-04-06"/>
        </div>   
