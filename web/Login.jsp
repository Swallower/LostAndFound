...
<div class="LoginWindow">
  ...
  <div>
    ...
    <form method="post" action="LoginSuccess.jsp"  class="login">

    <p>

      <label for="login">学号:</label>

      <input type="text" name="xuehao" id="id" placeholder ="用户名" >
    ...
    <span  class="registration"><a href="Register.jsp">Register</a></span>
