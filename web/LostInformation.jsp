...
<script type="text/javascript "src="ajax/studentQuery.js">

</script>
<%--<script src="JS/jquery-1.10.1.js" charset="UTF-8">--%>
<%--</script>--%>
<table class="table table-bordered table-hover">
    <caption class="h3 text-info" style="margin-bottom:15px;">拾得信息表</caption>
    <div class="box1">
        <label for="place" >地 点:</label>
        <select name="place" id="sel" onchange="getBuild()">
...
//            response.getWriter().write(new Gson().toJson(pick));
    %>
    ...
    <tr >
        <td colspan="8" align="center" style="padding-top:15px;">
            ...
            <a href="PickInformation.jsp?strpage=<%=uDao.LastPageLost(10) %>">末页</a>
            <form action="LostInformation.jsp" method="get">
