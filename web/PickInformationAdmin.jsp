...
%>
 ...
 <body>
     <table class="table table-bordered table-hover">
            <caption class="h3 text-info" style="margin-bottom:15px;">拾到信息表</caption>
        ...
        <%
        	UserDao  uDao = new UserDao();
        		...
        		int lastpage=uDao.LastPagePick(5);
        		int pageNum=1;//默认页
        		if(pages!=null){
        	try {
 ...
 <tr class="text-center" v-for="item in myData">
    ...
    margin-right: -80%;" href="Connection.jsp" target="_blank">联系</a>	
		<a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#layer" style="margin-right:40%;" href="DeleteInformationPick.jsp?id=<%=pick.getId()%>" target="_blank">删除</a>
